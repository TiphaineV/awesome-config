...
beautiful.font = "Deja Vu Sans 12"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "main", "internet", "mail", "social", "biblio", "obsidian", "7", "8", "9" }, s, awful.layout.layouts[1])
...
awful.rules.rules = {
    ...
    { rule = { class = "signal-desktop" }, properties = { screen = 1, tag = "4" } },
}
-- }}}
...
awful.spawn("/home/tiphaine/apps/Nextcloud")
